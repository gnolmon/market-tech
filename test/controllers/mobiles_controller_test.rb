...
class MobilesControllerTest < ActionController::TestCase
  ...
  test "should create mobile" do
    assert_difference('Mobile.count') do
      post :create, mobile: { description: @mobile.description, image_url: @mobile.image_url, name: @mobile.name, type: @mobile.type }
    end
  ...
  test "should update mobile" do
    patch :update, id: @mobile, mobile: { description: @mobile.description, image_url: @mobile.image_url, name: @mobile.name, type: @mobile.type }
    assert_redirected_to mobile_path(assigns(:mobile))
  end
