...
class TradersControllerTest < ActionController::TestCase
  ...
  test "should create trader" do
    assert_difference('Trader.count') do
      post :create, trader: { description: @trader.description, image_url: @trader.image_url, name: @trader.name }
    end
  ...
  test "should update trader" do
    patch :update, id: @trader, trader: { description: @trader.description, image_url: @trader.image_url, name: @trader.name }
    assert_redirected_to trader_path(assigns(:trader))
  end
